...
if [ "$LSB_RELEASE" == "24.10" ]; then
zenity --warning --text="<big>Skipping Chromium question since PPA used doesn't support Ubuntu 24.10.</big>" --title=De-Snapify --width=600
else
